...
void CArena::Create()
{
    ...
    CItem::CreateItems(this, ITEMPLACE_SOFTWALLS, m_pOptions->GetNumberOfItemsInWalls(ITEM_BOMB),
        m_pOptions->GetNumberOfItemsInWalls(ITEM_FLAME), m_pOptions->GetNumberOfItemsInWalls(ITEM_ROLLER),
        m_pOptions->GetNumberOfItemsInWalls(ITEM_KICK), m_pOptions->GetNumberOfItemsInWalls(ITEM_SKULL),
        m_pOptions->GetNumberOfItemsInWalls(ITEM_THROW), m_pOptions->GetNumberOfItemsInWalls(ITEM_PUNCH),
        m_pOptions->GetNumberOfItemsInWalls(ITEM_REMOTE), m_pOptions->GetNumberOfItemsInWalls(ITEM_SHIELD),
