...
void CTitle::OpenInput(void) { m_pInput->GetMainInput().Open(); }

//******************************************************************************************************************************
//******************************************************************************************************************************
//******************************************************************************************************************************

void CTitle::CloseInput(void) { m_pInput->GetMainInput().Close(); }
...
EGameMode CTitle::Update(void)
{
    ...
    else if (!m_HaveToExit)
    {
        ...
        if (m_pInput->GetMainInput().TestNext())
        {
            ...
            {
            case MENU_ITEM_GAME:
                m_ExitGameMode = GAMEMODE_MENU;
                break;
            case MENU_ITEM_DEMO:
                m_ExitGameMode = GAMEMODE_DEMO;
                break;
            case MENU_ITEM_OPTIONS:
                m_ExitGameMode = GAMEMODE_CONTROLS;
                break;
            case MENU_ITEM_CREDITS:
                m_ExitGameMode = GAMEMODE_GREETS;
                break;
            case MENU_ITEM_HELP:
                m_ExitGameMode = GAMEMODE_HELP;
                break;
            case MENU_ITEM_EXIT:
                m_ExitGameMode = GAMEMODE_EXIT;
                break;
            }
