...
CMenuTeam::~CMenuTeam() = default;

void CMenuTeam::OnCreate()
{
    // Make the hand cursor point to the first option
    m_CursorPlayer = 0;
}

void CMenuTeam::OnDestroy() { }
...
void CMenuTeam::OnPrevious()
{
    // Go to the previous screen
    Exit(MENUACTION_PREVIOUS);
}

void CMenuTeam::OnNext()
{
...
void CMenuTeam::OnUpdate() { }

void CMenuTeam::OnDisplay()
{
    ...
    for (int Player = 0; Player < MAX_PLAYERS; Player++)
    {
        ...
        m_pDisplay->DrawSprite(INITIAL_TEXT_POSITION_X + BOMBER_HEAD_SPACE_X + PositionX, PositionY + BOMBER_HEAD_SPACE_Y,
            nullptr, nullptr, BMP_MENU_BOMBER,
        ...
        if (m_CursorPlayer == Player)
        {
            ...
            m_pDisplay->DrawSprite(INITIAL_TEXT_POSITION_X + CURSOR_HAND_SPACE_X, PositionY + CURSOR_HAND_SPACE_Y, nullptr,
                nullptr, BMP_MENU_HAND, CURSOR_HAND_SPRITE, MENUTEAM_SPRITELAYER, CURSOR_HAND_PRIORITY);
        }
