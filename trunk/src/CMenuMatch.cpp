...
void CMenuMatch::OnDisplay()
{
    ...
    for (int Option = 0; Option < MENUMATCH_OPTIONS_COUNT; Option++)
    {
        ...
        case OPTION_MODE:
        {
            ...
            m_pFont->Draw(INITIAL_TEXT_POSITION_X + VALUE_TEXT_SPACE_X, PositionY, "%s",
        ...
        case OPTION_TIME:
        {
            ...
            else
            {
                ...
                m_pFont->Draw(INITIAL_TEXT_POSITION_X + VALUE_TEXT_SPACE_X, PositionY, "%d:%02d",
                    m_pOptions->GetTimeStartMinutes(), m_pOptions->GetTimeStartSeconds());
            }
            break;
        }
        ...
        case OPTION_TIMEUP:
        {
            ...
            else
            {
                // Display the time up
                m_pFont->Draw(INITIAL_TEXT_POSITION_X + VALUE_TEXT_SPACE_X, PositionY, "%d:%02d",
                    m_pOptions->GetTimeUpMinutes(), m_pOptions->GetTimeUpSeconds());
            }
        ...
        if (m_CursorOption == Option)
        {
            ...
            m_pDisplay->DrawSprite(INITIAL_TEXT_POSITION_X + CURSOR_HAND_SPACE_X, PositionY + CURSOR_HAND_SPACE_Y, nullptr,
                nullptr, BMP_MENU_HAND, CURSOR_HAND_SPRITE, MENUMATCH_SPRITELAYER, CURSOR_HAND_PRIORITY);
        }
