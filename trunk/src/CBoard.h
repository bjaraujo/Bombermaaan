...
inline void CBoard::SetDisplay(CDisplay* pDisplay) { m_pDisplay = pDisplay; }

inline void CBoard::SetOptions(COptions* pOptions) { m_pOptions = pOptions; }

inline void CBoard::SetScores(CScores* pScores) { m_pScores = pScores; }

inline void CBoard::SetClock(CClock* pClock) { m_pClock = pClock; }

inline void CBoard::SetTimer(CTimer* pTimer) { m_pTimer = pTimer; }

inline void CBoard::SetClockAnimation(bool AnimateClock) { m_AnimateClock = AnimateClock; }

inline void CBoard::SetArena(CArena* pArena) { m_pArena = pArena; }
