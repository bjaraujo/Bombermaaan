...
void CScroller::Create(
    int PositionX, int PositionY, int SpriteWidth, int SpriteHeight, float SpeedX, float SpeedY, float LoopTime)
{
...
bool CScroller::OutOfBounds()
{
    return (m_iPositionX > VIEW_WIDTH || m_iPositionX + m_SpriteWidth < 0 || m_iPositionY > VIEW_HEIGHT
        || m_iPositionY + m_SpriteHeight < 0);
}
