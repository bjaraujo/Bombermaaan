...
void CMenu::Create()
{
    ...
    m_pMosaic = CRandomMosaic::CreateRandomMosaic(m_pDisplay, MOSAIC_SPRITE_LAYER, MOSAIC_SPRITE_PRIORITY_IN_LAYER,
        MOSAIC_SPEED_X, MOSAIC_SPEED_Y, MOSAICCOLOR_BLUE, false);
...
void CMenu::OpenInput() { m_pInput->GetMainInput().Open(); }

void CMenu::CloseInput() { m_pInput->GetMainInput().Close(); }

EGameMode CMenu::Update()
{
