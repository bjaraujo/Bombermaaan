...
bool CExplosion::Update(float DeltaTime)
{
    ...
    if (!m_pArena->IsWall(m_BlockX, m_BlockY) || m_pArena->IsFallingWall(m_BlockX, m_BlockY))
    {
    ...
    if (m_Timer < ANIM_STATETIME1)
        m_State = STATE2;
    else if (m_Timer < ANIM_STATETIME2)
        m_State = STATE1;
    else if (m_Timer < ANIM_STATETIME3)
        m_State = STATE0;
    else if (m_Timer < ANIM_STATETIME4)
        m_State = STATE1;
    else if (m_Timer < ANIM_STATETIME5)
        m_State = STATE2;
    else if (m_Timer < ANIM_STATETIME6)
        m_State = STATE3;
    else
    {
        m_Dead = true;
