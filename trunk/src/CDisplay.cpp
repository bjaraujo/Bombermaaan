...
void CDisplay::SetProgramFolder(const std::string& pgmFolder)
{
#ifdef DIRECTX
    m_VideoDX.SetProgramFolder(pgmFolder);
#else
    m_VideoSDL.SetProgramFolder(pgmFolder);
#endif
}
...
bool CDisplay::LoadSprites(int SpriteTableWidth, int SpriteTableHeight, int SpriteWidth, int SpriteHeight, bool Transparent,
