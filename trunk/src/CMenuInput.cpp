...
CMenuInput::~CMenuInput() = default;

void CMenuInput::OnCreate()
{
...
void CMenuInput::OnDestroy() { }

void CMenuInput::OnUp()
{
    do
    {
...
void CMenuInput::OnPrevious()
{
    // Go to the previous screen
    Exit(MENUACTION_PREVIOUS);
}

void CMenuInput::OnNext()
{
...
void CMenuInput::OnUpdate() { }

void CMenuInput::OnDisplay()
{
    ...
    for (int Player = 0; Player < MAX_PLAYERS; Player++)
    {
        ...
        if (m_pOptions->GetBomberType(Player) == BOMBERTYPE_MAN)
        {
            ...
            m_pDisplay->DrawSprite(INITIAL_TEXT_POSITION_X + BOMBER_HEAD_SPACE_X, PositionY + BOMBER_HEAD_SPACE_Y, nullptr,
                nullptr, BMP_MENU_BOMBER, Player, MENUINPUT_SPRITELAYER, BOMBER_HEAD_PRIORITY);
            ...
            if (m_CursorPlayer == Player)
            {
                ...
                m_pDisplay->DrawSprite(INITIAL_TEXT_POSITION_X + CURSOR_HAND_SPACE_X, PositionY + CURSOR_HAND_SPACE_Y,
                    nullptr, nullptr, BMP_MENU_HAND, CURSOR_HAND_SPRITE, MENUINPUT_SPRITELAYER, CURSOR_HAND_PRIORITY);
            }
