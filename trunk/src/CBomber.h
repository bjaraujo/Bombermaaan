...
inline bool CBomber::IsAlive(void) { return m_Dead == DEAD_ALIVE; }

inline bool CBomber::IsDying(void) { return m_Dead == DEAD_DYING; }

inline bool CBomber::IsDead(void) { return m_Dead == DEAD_DEAD; }

inline bool CBomber::IsActor(void) { return m_Dead == DEAD_ALIVE && m_BomberState != BOMBERSTATE_STUNT; }

inline int CBomber::GetBlockX(void) { return m_BomberMove.GetBlockX(); }

inline int CBomber::GetBlockY(void) { return m_BomberMove.GetBlockY(); }

inline int CBomber::GetPlayer(void) { return m_Player; }

inline ESick CBomber::GetSickness(void) { return m_Sickness; }

inline bool CBomber::CanKickBombs(void) { return m_NumberOfKickItems > 0; }

inline bool CBomber::CanThrowBombs(void) { return m_NumberOfThrowItems > 0; }

inline bool CBomber::CanPunchBombs(void) { return m_NumberOfPunchItems > 0; }
...
inline bool CBomber::CanRemoteFuseBombs(void) { return m_NumberOfRemoteItems > 0; }

inline bool CBomber::HasShield() { return m_ShieldTime > 0.0f; }

inline float CBomber::TimeSinceLastSick() { return m_TimeSinceLastSick; }

inline int CBomber::GetUsedBombsCount(void) { return m_UsedBombs; }

inline int CBomber::GetBombItemsCount(void) { return m_NumberOfBombItems; }

inline int CBomber::GetFlameItemsCount(void) { return m_NumberOfFlameItems; }

inline int CBomber::GetRollerItemsCount(void) { return m_NumberOfRollerItems; }

inline int CBomber::GetTotalBombs(void) { return m_NumberOfBombItems + 1; }

inline int CBomber::GetX(void) { return m_BomberMove.GetX(); }

inline int CBomber::GetY(void) { return m_BomberMove.GetY(); }
...
inline EBomberState CBomber::GetState(void) { return m_BomberState; }
...
inline bool CBomber::HasExisted(void) { return m_HasExisted; }

inline void CBomber::ResetHasExisted(void) { m_HasExisted = false; }

inline EBomberType CBomber::GetBomberType(void) { return p_Options->GetBomberType(m_Player); }

inline void CBomber::SetTeam(CTeam* pTeam) { p_Team = pTeam; }

inline CTeam* CBomber::GetTeam(void) { return p_Team; }
