...
bool CAllegroInput::UpdateDevice(Allegro_Joystick* pDevice, void* pState, int StateSize) { return true; }
...
void CAllegroInput::UpdateKeyboard(void) { UpdateDevice(m_KeyState, MAX_KEYS); }
