...
set(SDLMIXER_LIBRARY ${c})
set(SDLMIXER_INCLUDE_DIR ${SDL2_MIXER_INCLUDE_DIRS})
set(SDLMIXER_FOUND ${SDL2_MIXER_FOUND})

mark_as_advanced(SDL2_MIXER_LIBRARY SDL2_MIXER_INCLUDE_DIR)

set(_sdl2mixer_incdir       ${SDL2_MIXER_INCLUDE_DIRS})
set(_sdl2mixer_lib          ${SDL2_MIXER_LIBRARIES})
...
if(NOT TARGET SDL2_mixer::SDL2_mixer)
    ...
    set_target_properties(SDL2_mixer::SDL2_mixer
        PROPERTIES
            ...
            IMPORTED_LOCATION "${_sdl2mixer_lib}"
